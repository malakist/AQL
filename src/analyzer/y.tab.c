...
#define AND 270
#define OR 271
#define FROM_BEGIN 272
#define WHERE_BEGIN 273
#define SELECT_BEGIN 274
#define Q_BEGIN 275
#define Q_END 276
...
static const char *const yytname[] =
{
  ...
  "STRING", "MEMBER_PTR", "EQ", "NE", "GT", "LT", "GE", "LE", "NOT", "AND",
  "OR", "FROM_BEGIN", "WHERE_BEGIN", "SELECT_BEGIN", "Q_BEGIN", "Q_END",
...
/* Line 1455 of yacc.c  */
#line 70 "aql.bison"
    { (yyval.nodePointer)=AQL::AqlNode::CreateDefaultNode(); printf("Identifier: \"%s\"\n", (yyvsp[(1) - (1)].idName)); }
    break;
...
/* Line 1455 of yacc.c  */
#line 71 "aql.bison"
    { (yyval.nodePointer)=AQL::AqlNode::CreateDefaultNode(); }
    break;
...
/* Line 1455 of yacc.c  */
#line 73 "aql.bison"
    { (yyval.nodePointer)=AQL::AqlNode::CreateDefaultNode(); printf("Integer: \"%s\"\n", (yyvsp[(1) - (1)].litValue)); }
    break;
...
/* Line 1455 of yacc.c  */
#line 74 "aql.bison"
    { (yyval.nodePointer)=AQL::AqlNode::CreateDefaultNode(); printf("Float: \"%s\"\n", (yyvsp[(1) - (1)].litValue)); }
    break;
...
/* Line 1455 of yacc.c  */
#line 75 "aql.bison"
    { (yyval.nodePointer)=AQL::AqlNode::CreateDefaultNode(); printf("String: \"%s\"\n", (yyvsp[(1) - (1)].litValue)); }
    break;
